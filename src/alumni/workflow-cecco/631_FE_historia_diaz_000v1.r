...
PARAM <- list()
PARAM$experimento <- "FE000v1-diaz"

PARAM$exp_input <- "DR000v1-diaz"
...
PARAM$RandomForest$semilla <- 102797 # cambiar por la propia semilla
...
PARAM$CanaritosAsesinos$semilla <- 102769
