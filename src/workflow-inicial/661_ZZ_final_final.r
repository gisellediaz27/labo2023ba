...
PARAM <- list()
PARAM$experimento <- "ZZ6610F"
PARAM$exp_input <- "HT6510F"
...
PARAM$semillas <- c(102797,
                    102769,
                    101839,
                    110623,
                    110771,
                    215478,  # Nueva semilla 1
                    315678,  # Nueva semilla 2
                    415278,  # Nueva semilla 3
                    525178,  # Nueva semilla 4
                    635278)  # Nueva semilla 5)

PARAM$kaggle$envios_desde <- 9500L
PARAM$kaggle$envios_hasta <- 15500L
